...
app.use(
    helmet.contentSecurityPolicy({
        directives: {
            ...
            scriptSrc: [
                "'self'", 
                "https://maps.googleapis.com", // Allow scripts from Google Maps
            ],
            imgSrc: [
                "'self'", 
                "data:", 
            ...
            frameSrc: [
                ...
                "https://www.google.com", // Allow Google Maps frames
            ],
            connectSrc: [
                "'self'", 
                "https://maps.googleapis.com", // Allow API calls to Google Maps
            ],
        },
    })
);
